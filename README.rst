...
2. Obtain your _Master Key_ from the Master Keys tab of your Account Settings: (https://m2x.att.com/account)
3. Create your first Data Source Blueprint and copy its _Feed ID_.: (https://m2x.att.com/blueprints)
